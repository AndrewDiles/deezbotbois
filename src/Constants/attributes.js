...
export const attributeInfo = {
	...
	RangedShieldPenetratio: "Ranged Shield Penetration: multiplier applied to target's Shield during a ranged attack",
	...
	elevenAttackMeleeCommand: "Enables the execution of the ELEVEN command with melee weapons",
	elevenAttackRangedCommand:"Enables the execution of the ELEVEN command with ranged weapons",
